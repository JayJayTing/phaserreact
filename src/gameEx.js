...
export default function game() {
	...
	let gameOver = false;
	function preload() {
		this.load.image("sky", "assets/gameEx/sky.png");
		this.load.image("ground", "assets/gameEx/platform.png");
		this.load.image("star", "assets/gameEx/star.png");
		this.load.image("bomb", "assets/gameEx/bomb.png");
		this.load.spritesheet("dude", "assets/gameEx/man.png", {
			frameWidth: 187,
			frameHeight: 324
		});
	}
